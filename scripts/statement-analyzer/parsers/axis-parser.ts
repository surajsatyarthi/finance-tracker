 ...
 * Supports: Neo, My Zone, Rewards, and other Axis cards
 */
export class AxisParser extends BaseParser {
    ...
    parseStatement(text: string): StatementData {
        // Extract card name
        let cardName = 'Axis'
        if (text.includes('Neo')) cardName = 'Axis Neo'
        else if (text.includes('My Zone')) cardName = 'Axis My Zone'
        else if (text.includes('Rewards')) cardName = 'Axis Rewards'
